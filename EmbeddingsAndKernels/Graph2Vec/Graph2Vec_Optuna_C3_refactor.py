...
labels["Organism_shortname"] = pd.Categorical(
    labels["Organism_shortname"], categories=orgsc3, ordered=True
)
...
# if os.path.exists("../../data/optuna_studies/NewGraph2VecParamOpt/graph2vecC3.pkl"):
#     with open(
#         "../../data/optuna_studies/NewGraph2VecParamOpt/graph2vecC3.pkl", "rb"
#     ) as f:
#         study = pickle.load(f)
...
#     with open("../../data/optuna_studies/Graph2VecParamOpt/graph2vecC3.pkl", "wb") as f:
#         pickle.dump(study, f)
#         print("SAVED!!")
...
# Save
with open("../../data/optuna_studies/graph2vecC3.pkl", "wb") as f:
    pickle.dump(study, f)
    # print("SAVED!!")
